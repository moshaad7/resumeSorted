  ...
  return (
    <div id='main'>
      <div className='header'>
        ...
        <div className='right'>
          <a href='https://github.com/moshaad7/resumeSorted'>Contribute</a>
          <a href='https://github.com/moshaad7/resumeSorted'>Give a star</a>
        </div>
      </div>
          ...
          <div className='up'>
            ...
            <div className='theme'>
              ...
              <div
                ...
                style={{
                  background: 'linear-gradient(45deg, black, #cddc39)',
                }}
                onClick={() => {
                  setprimary('black')
                  setsecondary('#cddc39')
...
//Mohd Shaad Khan Code officially
